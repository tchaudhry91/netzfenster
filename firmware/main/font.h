// Adafruit 5x7 font (from glcdfont.c)
// 256 characters (0x00-0xFF), 5 bytes each = 1280 bytes
// Each character is 5 columns; bit 0 of each byte is the top row.
// Index: font[c * 5] = first byte of character c
#ifndef FONT_H
#define FONT_H
